...
PCA_SCORES_EUR_AJ_1KG = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/13_pca_scores.european_and_aj.1kg.tsv'
...
EUROPEAN_AND_AJ_SAMPLES = 'gs://dalio_bipolar_w1_w2_hail_02/data/samples/12_european_and_aj.sample_list'
...
ht_european_and_aj_samples = hl.import_table(EUROPEAN_AND_AJ_SAMPLES, no_header=True, key='f0')
...
mt = mt.filter_cols(hl.is_defined(ht_european_and_aj_samples[mt.col_key]))
...
pca_output.flatten().export(output=PCA_SCORES_EUR_AJ_1KG)
